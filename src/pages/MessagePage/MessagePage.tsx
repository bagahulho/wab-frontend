...
const MessagePage: React.FC = () => {
    ...
    const handleToggleSound = async (chatId: number) => {
        ...
        try {
            ...
            alerconsole.logt("Ошибка при переключении звука");
        }
    };
                                        ...
                                        <div className="delete-chat">
                                            <label htmlFor={`delete-chat-btn-${chat.id}`}>
                                                <svg
                                                    ...
                                                    xmlns="http://www.w3.org/2000/svg"
                                                >
                                                    <path d="M18 7L9.42857 17L6 13" stroke="#0095FF" strokeWidth="1.5"
                                                          stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M18 7L11.767 14.2718" stroke="#363853" strokeWidth="1.5"
                                                          stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                            </label>
                                        </div>
